    ...
    private void sendMessages() {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance().getReference().child("UserMessages").child(eventId)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages.orderByChild("time").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                listView.setLayoutManager(new LinearLayoutManager(ChatActivity2.this
